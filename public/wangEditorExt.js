...
window.wangEditor.fullscreen = {
  init: function(editor) {
    ...
    $(toolbar).append(
      '<div class="w-e-menu btn_fullscreen" οnclick="window.wangEditor.fullscreen.run(\'' +
        id +
        '\')">全屏</div>'
    )
  },
...
window.wangEditor.viewSource = {
  init: function(editor) {
    ...
    toolbar = editor.$toolbarElem[0]
    $(toolbar).append(
      "<div class='w-e-menu btn_viewSource' title='查看源码' οnclick='window.wangEditor.viewSource.run(\"" +
        id +
        '")\'>源</div>'
    )
  },
